...
def LE_xy_surface_concate_plane(alpha, z0ly, ct, x):
    ...
    def calculation(alpha, z0ly, ct, a, r_le2, r_le, x):
        ...
        cossigma, flux = fb.brightness(x_inter, y_inter, z_inter, ct)
        ...
        return new_xs, new_ys, flux, act, ange, cossigma
    ...
    if z0ly < 0:
        ...
        if ti >= ct:
            ...
            new_xs, new_ys, flux, act, ange, cossigma = calculation(alpha, z0ly, ct, a, r_le2, r_le, x)
            return new_xs, new_ys, flux, act, ange, cossigma
    else:
        new_xs, new_ys, flux, act, ange, cossigma = calculation(alpha, z0ly, ct, a, r_le2, r_le, x)
        return new_xs, new_ys, flux, act, ange, cossigma
...
def LE_xy_surface_concate_sphere(r0ly, ct, x):
    ...
    def calculation(r0ly, ct, r_le2, r_le, x):
        ...
        return new_xs, new_ys, flux, ange, cossigma


    if r0ly > 0:
        new_xs, new_ys, flux, ange, cossigma = calculation(r0ly, ct, r_le2, r_le, x)
        return new_xs, new_ys, flux, ange, cossigma
    else:
        print("No LE")
        return 0,0,0,0,0
