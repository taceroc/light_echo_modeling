...
for ct in [130, 250]: #alpha = 0 done
# for al in [0, 15, 45, 75, 120, 310]:
    ...
    new_xs_v838, new_ys_v838, flux_v838, act_v838, ange_v838, cossigma_v838 = le_geo.LE_xy_surface_concate_plane(alpha, vc.z0ly, ctyi, x)
    ...
    np.save(path_ge+r"plane_nd_flux_v838_t%s.npy"%(ct), flux_v838)  
    ...
    le_pl.plot(new_xs_v838, new_ys_v838, flux_v838, alpha, act_v838, axes, fig, save = False, name = "name")
...
#     xmax = r_le-a*vc.ct
#     x = np.linspace(xmin,xmax,1000)
#     new_xs_v838, new_ys_v838, flux_v838, act_v838, ange_v838, cossigma_v838 = le_geo.LE_xy_surface_concate_plane(al, vc.z0ly, vc.ct, x)
#     path_ge = r"C:\Users\\tac19\\OneDrive\\Documents\\UDEL\\Project_RA\\LE\\Simulation\\results\\num\\"
#     np.save(path_ge+r"plane_nd_xs_v838_a%s.npy"%(al), new_xs_v838)
#     np.save(path_ge+r"plane_nd_ys_v838_a%s.npy"%(al), new_ys_v838)
#     np.save(path_ge+r"plane_nd_flux_v838_a%s.npy"%(al), flux_v838)
...
#     fig, axes = plt.subplots(1, 1, figsize=(10, 8))
#     le_pl.plot(new_xs_v838, new_ys_v838, flux_v838, al, act_v838, axes, fig, save = False, name = "name")
